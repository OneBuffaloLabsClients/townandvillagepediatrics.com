...
export default function NotFound() {
  return (
    <div className="min-h-[70vh] flex items-center justify-center bg-[var(--color-background-alt)] px-4 py-16">
      <ClientRedirect>
        <div className="text-center max-w-lg mx-auto fade-in">
          {/* Fun Icon Animation */}
          ...
          <p className="text-[var(--color-text-muted)] mb-10 leading-relaxed">
            We can&apos;t seem to find the page you&apos;re looking for. You might have typed the
            address incorrectly, or the page may have moved. Don&apos;t worry, we can help you find
            your way back.
          </p>
